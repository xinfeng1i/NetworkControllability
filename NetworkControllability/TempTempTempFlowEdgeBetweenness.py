...
def EdgeAttack(G):
    ...
    print '########## Edge IBA ##########'
    G4 = copy.deepcopy(G)
    EdgeBetweenness = nx.edge_betweenness_centrality(G4, k=1500)
    #EdgeBetweenness = nx.edge_current_flow_betweenness_centrality(G4, solver='lu')
    ...
    while i < int(F1 * EdgesNum):
        ...
        EdgeBets = nx.edge_betweenness_centrality(G5, k=1500)
...
if __name__ == "__main__":
    ...
    print 'Edge Attack From Temp Temp Temp Approximate Edge Betweenness ... '
    print 'Internet --- P2P_3.net'
    NodesNum = G.number_of_nodes()
    EdgesNum = G.number_of_edges()
